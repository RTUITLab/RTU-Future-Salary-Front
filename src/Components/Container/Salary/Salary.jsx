    ...
    return (
        <div className={'outer'}>
            <div className={'container'}>
                ...
                <h2 className={s.subtitle}>Заполните все необходимые поля</h2>
                ...
                >
                    ...
                    (<Form>
                        ...
                        <div className={s.section}>
                            <label className={s.label}  htmlFor="dateOfBirth">Укажите Вашу дату рождения</label>
                            <Field
                                id="dateOfBirth"
                                type="date"
                                name="dateOfBirth"
                        ...
                        <div className={s.dissertationContainer}>
                            <label className={s.label} htmlFor="dateOfDissertationDefense">Предположительная дата защиты кандидатской диссертации: </label>
                            {/*<Field*/}
                            {/*    id="dateOfDissertationDefense"*/}
                            {/*    type="date"*/}
                            {/*    name="dateOfDissertationDefense"*/}
                            {/*    disabled*/}
                            {/*    // component={<span>{values.dateOfDissertationDefense}</span>}*/}
                            {/*/>*/}
                            <span className={s.dissertation}>{values.dateOfDissertationDefense}</span>
